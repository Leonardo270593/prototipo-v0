// InflaçãoPessoal · Tela: Cesta — Drill-down Light · WCAG AA
"use client"
...
function AccordionItem({ label, weight, total, products }: AccordionItemProps) {
  ...
  return (
    <div
      ...
      style={{ background: open ? "rgba(3,105,161,0.05)" : T.surface2, border: `1px solid ${open ? T.accent : T.border}` }}
    >
      <button
...
// ── Tela principal ─────────────────────────────────────────────────────────────
export function ScreenBasketDetailLight() {
