...
export function ScreenDirectionA() {
  return (
    <div
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto pb-24 px-5 pt-2">
        ...
        >
          ...
          <p className="text-xs mb-3 relative z-10" style={{ color: T.fgCardMeta }}>
          ...
          <div className="flex items-start justify-between mb-4 relative z-10">
            <div>
              <p
                ...
                style={{ color: T.destructive, fontFamily: T.font, textShadow: "0 0 20px rgba(248,113,113,0.25)" }}
              >
                +5,2%
              </p>
        ...
        {/* Chart Section */}
        <div className="mb-6">
          <p className="font-bold text-base mb-3" style={{ color: T.fg, fontFamily: T.font }}>
            Inflação
          </p>
          <InflationChart
            ...
            chipTextColor={T.fgSecondary}
            noteBgColor={T.surface}
            noteTextColor={T.fgMuted}
            borderColor=""
            textPrimary={T.fg}
            textMuted={T.fgMuted}
              ...
              <div>
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <span
                    ...
                    style={{ background: "rgba(56,189,248,0.12)", color: T.accent }}
                  >
                    ★ destaque
                  </span>
                </div>
